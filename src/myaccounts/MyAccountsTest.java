...
public class MyAccountsTest extends Utiltiy {
    ...
    public void selectMyAccountOptions(String option, By by) {
        //1.2 Handle List of Element and Select options)
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("input-firstname"), "romik");
        //3.4 Enter Last Name
        sendTextToElement(By.id("input-lastname"), "bhagdu");
        //3.5 Enter Email
        sendTextToElement(By.id("input-email"), "rromikbhagdu15@gmail.com");
        //3.6 Enter Telephone
        sendTextToElement(By.id("input-telephone"), "8524567530");
        //3.7 Enter Password
        sendTextToElement(By.id("input-password"), "PPdd123");
        //3.8 Enter Password Confirm
        sendTextToElement(By.id("input-confirm"), "PPdd123");
        ...
        //3.15 Call the  method and pass the parameter Logout
